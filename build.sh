...
export BUILD_CROSS_COMPILE=~/arm64/bin/aarch64-linux-gnu-
...
[ $MODEL = "S7" ] && cp -f $WORKDIR/arch/arm64/configs/exynos8890-herolte_defconfig $KERNELCONFIG
[ $MODEL = "S7E" ] && cp -f $WORKDIR/arch/arm64/configs/exynos8890-hero2lte_defconfig $KERNELCONFIG
cd $WORKDIR
